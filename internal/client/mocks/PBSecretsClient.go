...
// PBSecretsClient is an autogenerated mock type for the SecretsClient type
type PBSecretsClient struct {
	mock.Mock
}

// CreateSecret provides a mock function with given fields: ctx, in, opts
func (_m *PBSecretsClient) CreateSecret(ctx context.Context, in *gen.CreateSecretRequest, opts ...grpc.CallOption) (*gen.CreateSecretResponse, error) {
...
func (_m *PBSecretsClient) DeleteSecret(ctx context.Context, in *gen.DeleteSecretRequest, opts ...grpc.CallOption) (*gen.DeleteSecretResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *PBSecretsClient) GetSecret(ctx context.Context, in *gen.GetSecretRequest, opts ...grpc.CallOption) (*gen.GetSecretResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *PBSecretsClient) ListSecrets(ctx context.Context, in *gen.ListSecretsRequest, opts ...grpc.CallOption) (*gen.ListSecretsResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *PBSecretsClient) UpdateSecret(ctx context.Context, in *gen.UpdateSecretRequest, opts ...grpc.CallOption) (*gen.UpdateSecretResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// NewPBSecretsClient creates a new instance of PBSecretsClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewPBSecretsClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *PBSecretsClient {
	mock := &PBSecretsClient{}
	mock.Mock.Test(t)
